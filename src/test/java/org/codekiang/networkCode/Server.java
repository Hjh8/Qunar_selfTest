...
public class Server {
    ...
    public static org.codekiang.networkCode.AnalysisUtils.AnalysisData parseUrl(String url){
        if (Strings.isNullOrEmpty(url)){
            return new org.codekiang.networkCode.AnalysisUtils.AnalysisData();
        }
        String context = org.codekiang.networkCode.AnalysisUtils.HttpAnalysis.getContextByUrl(url);
