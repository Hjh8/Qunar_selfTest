...
public class HttpAnalysis {
     ...
     *      3 标点符号数
     */
    public static org.codekiang.networkCode.AnalysisUtils.AnalysisData getAnalysisData(String content){
        org.codekiang.networkCode.AnalysisUtils.AnalysisData analysisData = new AnalysisData();
        ...
        analysisData.setTotal(content.length() + chinaCount*2);
